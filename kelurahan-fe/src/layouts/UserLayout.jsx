    ...
    <div className="flex h-screen bg-gray-100 font-sans" data-theme="light">
      ...
      >
        ...
        <div className="p-4 border-t border-blue-700/50 bg-blue-900/20">
          <button
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 p-3 rounded-xl text-sm font-semibold text-red-100 bg-red-600/20 hover:bg-red-600 hover:text-white transition-all duration-200 border border-red-500/30 group"
          >
