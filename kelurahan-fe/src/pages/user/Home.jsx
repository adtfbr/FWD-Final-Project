...
const NewsSection = ({ loading, beritaList, onSelectBerita }) => (
...
const BeritaDetailModal = ({ berita, onClose }) => {
      ...
      <div className="bg-white w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden animate-fade-in-up max-h-[90vh] flex flex-col">
        ...
        <div className="p-8 overflow-y-auto">
          ...
          <div className="text-sm text-gray-500 mb-6 flex items-center gap-2">
            <span>{new Date(berita.created_at).toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</span>
            <span>•</span>
